...
registerOnClick('Cube.017', false, false, [0,1,2], false, function(event) {
    tweenCamera('Empty.001', 'Cube.006', 1, function() {}, 0);
}, function(event) {});
registerOnClick('Cube.006', false, false, [0,1,2], false, function(event) {
    tweenCamera('Empty.001', 'Plane.004', 1, function() {}, 0);
}, function(event) {});
registerOnClick('Plane.003', false, false, [0,1,2], false, function(event) {
    tweenCamera('Empty.001', 'Plane', 1, function() {}, 0);
}, function(event) {});
registerOnClick('Plane', false, false, [0,1,2], false, function(event) {
    tweenCamera('Empty.001', 'Plane.001', 1, function() {}, 0);
}, function(event) {});
registerOnClick('Plane.004', false, false, [0,1,2], false, function(event) {
    tweenCamera('Empty.001', 'Plane.003', 1, function() {}, 0);
}, function(event) {});
